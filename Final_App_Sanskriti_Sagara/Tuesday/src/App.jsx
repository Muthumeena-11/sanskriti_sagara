...
import Whiteboard from './components/Whiteboard';
import TamilAlphabet from './components/TamilAlphabet';
import StateCards from './components/states';
import './App.css';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/learn-colors/telugu" element={<LearnColorsTelugu />} />
        <Route path="/learn-colors/tamil" element={<LearnColorsTamil />} />
        <Route path="/learn-colors/hindi" element={<LearnColorsHindi />} />
        <Route path="/color-options" element={<ColorOptions />} />
        <Route path="/game-board" element={<GameBoard />} />
        <Route path="/actions" element={<ActionSelector />} />
        <Route path="/whiteboard" element={<Whiteboard />} />
        <Route path="/tamil-alphabet" element={<TamilAlphabet />} />
        <Route path="/states" element={<StateCards />} />
      </Routes>
    </Router>
  );
}
